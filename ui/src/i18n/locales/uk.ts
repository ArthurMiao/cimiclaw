...
export const uk: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Редагування CimiClaw.json.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "На мобільному? Скопіюйте повний URL (включно з #token=...) з CimiClaw dashboard --no-open на вашому комп’ютері.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — повторно виконайте авторизацію через CimiClaw models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste: "Вставте токен з CimiClaw dashboard --no-open або введіть налаштований пароль.",
        stepGenerate:
          "Якщо токен не налаштовано, виконайте CimiClaw doctor --generate-gateway-token на хості Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Виконайте CimiClaw dashboard --no-open і відкрийте свіжий URL або вставте його токен.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Виконайте CimiClaw devices list на хості Gateway.",
        stepApproveId: "Схваліть цей запит: CimiClaw devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Знову відкрийте наданий dashboard через CimiClaw dashboard, щоб UI і Gateway походили з однієї інсталяції.",
        stepDevUi:
      ...
      network: {
        ...
        stepGateway:
          "Підтвердьте, що Gateway працює, через CimiClaw status або CimiClaw gateway run.",
        stepUrl:
          "Перевірте WebSocket URL і використовуйте wss://, коли Gateway знаходиться за HTTPS/Tailscale Serve.",
        stepDashboard:
          "Знову відкрийте dashboard через CimiClaw dashboard --no-open, щоб повторно скопіювати поточний URL і деталі auth.",
      },
    },
  },
  chat: {
