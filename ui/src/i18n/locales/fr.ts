...
export const fr: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Sur mobile ? Copiez l’URL complète (y compris #token=...) depuis CimiClaw dashboard --no-open sur votre ordinateur.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — réauthentifiez-vous avec CimiClaw models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Collez le jeton de CimiClaw dashboard --no-open ou saisissez le mot de passe configuré.",
        stepGenerate:
          "Si aucun jeton n’est configuré, exécutez CimiClaw doctor --generate-gateway-token sur l’hôte Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Exécutez CimiClaw dashboard --no-open et ouvrez la nouvelle URL ou collez son jeton.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Exécutez CimiClaw devices list sur l’hôte Gateway.",
        stepApproveId: "Approuvez cette demande : CimiClaw devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Rouvrez le dashboard servi avec CimiClaw dashboard afin que l’UI et le Gateway viennent de la même installation.",
        stepDevUi:
      ...
      network: {
        ...
        stepGateway:
          "Confirmez que le Gateway fonctionne avec CimiClaw status ou CimiClaw gateway run.",
        stepUrl:
          "Vérifiez l’URL WebSocket et utilisez wss:// lorsque le Gateway est derrière HTTPS/Tailscale Serve.",
        stepDashboard:
          "Rouvrez le dashboard avec CimiClaw dashboard --no-open pour recopier l’URL actuelle et les détails d’authentification.",
      },
    },
  },
  chat: {
