...
export const tr: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "CimiClaw.json dosyasını düzenleyin.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Mobilde misiniz? Masaüstünüzde CimiClaw dashboard --no-open komutundan tam URL'yi (#token=... dahil) kopyalayın.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — CimiClaw models auth ile yeniden kimlik doğrulayın",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "CimiClaw dashboard --no-open çıktısındaki tokenı yapıştırın veya yapılandırılmış parolayı girin.",
        stepGenerate:
          "Token yapılandırılmamışsa Gateway ana makinesinde CimiClaw doctor --generate-gateway-token çalıştırın.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "CimiClaw dashboard --no-open çalıştırın ve yeni URL’yi açın veya tokenını yapıştırın.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Gateway hostunda CimiClaw devices list çalıştırın.",
        stepApproveId: "Bu isteği onaylayın: CimiClaw devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "UI ve Gateway aynı kurulumdan gelsin diye sunulan dashboardı CimiClaw dashboard ile yeniden açın.",
        stepDevUi:
          "pnpm ui:dev kullanıyorsanız geliştirme UI’sini mevcut checkouta göre yeniden derleyin veya yeniden başlatın.",
        stepRestart:
          "CimiClaw güncellemesinden sonra Gateway’i yeniden başlatın, böylece güncel protokolü sunsun.",
      },
      network: {
        title: "Bağlanılamadı",
        summary:
        ...
        stepGateway:
          "CimiClaw status veya CimiClaw gateway run ile Gateway’in çalıştığını doğrulayın.",
        stepUrl:
          "WebSocket URL’sini kontrol edin ve Gateway HTTPS/Tailscale Serve arkasındaysa wss:// kullanın.",
        stepDashboard:
          "Geçerli URL ve auth ayrıntılarını yeniden kopyalamak için dashboardı CimiClaw dashboard --no-open ile yeniden açın.",
      },
    },
  },
  chat: {
