...
export const pl: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Na urządzeniu mobilnym? Skopiuj pełny URL (w tym #token=...) z CimiClaw dashboard --no-open na komputerze.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — uwierzytelnij ponownie za pomocą CimiClaw models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste: "Wklej token z CimiClaw dashboard --no-open albo wpisz skonfigurowane hasło.",
        stepGenerate:
          "Jeśli token nie jest skonfigurowany, uruchom CimiClaw doctor --generate-gateway-token na hoście Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Uruchom CimiClaw dashboard --no-open i otwórz świeży URL albo wklej jego token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Uruchom CimiClaw devices list na hoście Gateway.",
        stepApproveId: "Zatwierdź to żądanie: CimiClaw devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Otwórz ponownie udostępniany dashboard poleceniem CimiClaw dashboard, aby UI i Gateway pochodziły z tej samej instalacji.",
        stepDevUi:
          "Jeśli używasz pnpm ui:dev, przebuduj lub uruchom ponownie UI dev względem bieżącego checkoutu.",
        stepRestart:
          "Zrestartuj Gateway po aktualizacji CimiClaw, aby udostępniał bieżący protokół.",
      },
      network: {
        ...
        stepGateway:
          "Potwierdź, że Gateway działa, używając CimiClaw status lub CimiClaw gateway run.",
        stepUrl: "Sprawdź URL WebSocket i użyj wss://, gdy Gateway jest za HTTPS/Tailscale Serve.",
        stepDashboard:
          "Otwórz ponownie dashboard przez CimiClaw dashboard --no-open, aby skopiować bieżący URL i szczegóły auth.",
      },
    },
  },
  chat: {
