...
function buildFeedback(params: {
  ...
  const docsHref = params.docsHref ?? "https://docs.cimiclaw.ai/web/dashboard";
  return {
    kind: params.kind,
...
export function resolveLoginFailureFeedback(
  ...
  if (pairing) {
    return buildFeedback({
      ...
      rawError,
      docsHref: "https://docs.cimiclaw.ai/web/control-ui#device-pairing-first-connection",
      titleKey:
  ...
  if (shouldShowInsecureContextHint(false, rawError, lastErrorCode)) {
    return buildFeedback({
      ...
      rawError,
      docsHref: "https://docs.cimiclaw.ai/web/control-ui#insecure-http",
  ...
  if (
    ...
    return buildFeedback({
      ...
      rawError,
      docsHref:
        "https://docs.cimiclaw.ai/web/control-ui#debuggingtesting-dev-server--remote-gateway",
      ...
      <div class="login-gate__card">
          ...
          <label class="field">
            ...
            <div class="login-gate__secret-row">
              <input
                ...
                placeholder="CIMICLAW_GATEWAY_TOKEN (${t("login.passwordPlaceholder")})"
        ...
        <div class="login-gate__help">
          ...
          <ol class="login-gate__steps">
            <li>
              ${t("overview.connection.step1")}${renderConnectCommand("cimiclaw gateway run")}
            </li>
            <li>${t("overview.connection.step2")} ${renderConnectCommand("cimiclaw dashboard")}</li>
