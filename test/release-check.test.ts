  ...
  it("blocks legacy runtime dependency stamps from npm pack output", () => {
    expect(
      collectForbiddenPackPaths([
        ...
        "dist/extensions/codex/.cimiclaw-runtime-deps-backup-node_modules-old/zod/index.js",
        "dist/extensions/discord/.cimiclaw-runtime-deps-stamp.json",
      ]),
    ).toEqual([
      "dist/extensions/browser/.cimiclaw-Install-Stage/package.json",
      "dist/extensions/codex/.cimiclaw-runtime-deps-backup-node_modules-old/zod/index.js",
...
describe("collectMissingPackPaths", () => {
  it("requires the shipped channel catalog, control ui, and optional bundled metadata", () => {
    ...
    for (const path of [
      ...
      bundledDistPluginFile("slack", "cimiclaw.plugin.json"),
      bundledDistPluginFile("slack", "package.json"),
      bundledDistPluginFile("telegram", "runtime-api.js"),
      bundledDistPluginFile("telegram", "cimiclaw.plugin.json"),
