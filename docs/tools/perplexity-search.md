...
`~/.cimiclaw/cimiclaw.json` under `plugins.entries.perplexity.config.webSearch.apiKey`.
...
`~/.cimiclaw/.env` (or your service environment). See [Env vars](/help/faq#env-vars-and-env-loading).
