...
{
  agents: {
    list: [{ id: "support", name: "Support", workspace: "~/.cimiclaw/workspace-support" }],
  },
  bindings: [
...
Session stores live under the state directory (default `~/.cimiclaw`):

- `~/.cimiclaw/agents/<agentId>/sessions/sessions.json`
