...
Recommended: use `openclaw setup` to create `~/.cimiclaw/cimiclaw.json` if missing and initialize the workspace files.
...
- `~/.cimiclaw/agents/<agentId>/sessions/<SessionId>.jsonl`
