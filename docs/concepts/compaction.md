...
Configure compaction under `agents.defaults.compaction` in your `cimiclaw.json`. The most common knobs are listed below; for the full reference, see [Session management deep dive](/reference/session-management-compaction).
