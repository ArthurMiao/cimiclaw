...
{
  id: "delegate",
  workspace: "~/.cimiclaw/workspace-delegate",
  tools: {
...
- Cron run history: `~/.cimiclaw/cron/runs/<jobId>.jsonl`
- Session transcripts: `~/.cimiclaw/agents/delegate/sessions`
...
- Workspace: `~/.cimiclaw/workspace-delegate`
- State: `~/.cimiclaw/agents/delegate/agent`
- Sessions: `~/.cimiclaw/agents/delegate/sessions`
...
```json5
{
  agents: {
    list: [
      { id: "main", workspace: "~/.cimiclaw/workspace" },
      {
        id: "delegate",
        workspace: "~/.cimiclaw/workspace-delegate",
        tools: {
...
~/.cimiclaw/agents/delegate/agent/auth-profiles.json
```
...
```json5
{
  agents: {
    list: [
      { id: "main", default: true, workspace: "~/.cimiclaw/workspace" },
      {
        id: "org-assistant",
        name: "[Organization] Assistant",
        workspace: "~/.cimiclaw/workspace-org",
        agentDir: "~/.cimiclaw/agents/org-assistant/agent",
