...
```bash
sudo tccutil reset Accessibility ai.cimiclaw.mac
sudo tccutil reset ScreenCapture ai.cimiclaw.mac
...
Workaround: move files into the OpenClaw workspace (`~/.cimiclaw/workspace`) if you want to avoid per-folder grants.
