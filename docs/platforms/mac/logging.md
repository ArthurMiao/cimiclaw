...
EOF
sudo install -m 644 -o root -g wheel /tmp/ai.cimiclaw.plist /Library/Preferences/Logging/Subsystems/ai.cimiclaw.plist
```
...
- Remove the override: `sudo rm /Library/Preferences/Logging/Subsystems/ai.cimiclaw.plist`.
