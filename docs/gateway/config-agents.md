...
- **`agentToAgent.maxPingPongTurns`**: maximum reply-back turns between agents during agent-to-agent exchanges (integer, range: `0`â€“`5`). `0` disables ping-pong chaining.
