...
describe("registerPreActionHooks", () => {
  ...
  it("handles debug mode and config-only command preaction", async () => {
    ...
    await runPreAction({
      parseArgv: ["status"],
      processArgv: ["node", "cimiclaw", "status", "--debug"],
    });
    ...
    await runPreAction({
      ...
      processArgv: ["node", "cimiclaw", "agents", "list"],
    });
  ...
  it("loads plugins for text local agent runs", async () => {
    await runPreAction({
      parseArgv: ["agent"],
      processArgv: ["node", "cimiclaw", "agent", "--local", "--message", "hi"],
    });
  ...
  it("loads plugins for json local agent runs", async () => {
    await runPreAction({
      parseArgv: ["agent"],
      processArgv: ["node", "cimiclaw", "agent", "--local", "--message", "hi", "--json"],
    });
  ...
  it("keeps setup alias and channels add manifest-first", async () => {
    await runPreAction({
      parseArgv: ["onboard"],
      processArgv: ["node", "cimiclaw", "onboard"],
    });
    ...
    await runPreAction({
      ...
      processArgv: ["node", "cimiclaw", "channels", "add"],
    });
  ...
  it("skips startup bootstrap for parent default help actions", async () => {
    await runPreAction({
      parseArgv: ["channels"],
      processArgv: ["node", "cimiclaw", "channels"],
    });
  ...
  it("lets configure own config validation and plugin loading", async () => {
    await runPreAction({
      parseArgv: ["configure"],
      processArgv: ["node", "cimiclaw", "configure"],
    });
  ...
  it("only allows invalid config for explicit Discord reinstall requests", async () => {
    await runPreAction({
      ...
      processArgv: ["node", "cimiclaw", "plugins", "install", "@openclaw/discord"],
    });
    ...
    await runPreAction({
      ...
      processArgv: ["node", "cimiclaw", "plugins", "install", "alpha"],
    });
    ...
    await runPreAction({
      ...
      processArgv: ["node", "cimiclaw", "plugins", "install", DISCORD_REPO_INSTALL_SPEC],
    });
  ...
  it("skips help/version preaction and respects banner opt-out", async () => {
    await runPreAction({
      parseArgv: ["status"],
      processArgv: ["node", "cimiclaw", "--version"],
    });
    ...
    await runPreAction({
      parseArgv: ["status"],
      processArgv: ["node", "cimiclaw", "status"],
    });
  ...
  it("applies --json stdout suppression only for explicit JSON output commands", async () => {
    await runPreAction({
      parseArgv: ["status"],
      processArgv: ["node", "cimiclaw", "status", "--json"],
    });
    ...
    await runPreAction({
      ...
      processArgv: ["node", "cimiclaw", "update", "status", "--json"],
    });
    ...
    await runPreAction({
      ...
      processArgv: ["node", "cimiclaw", "config", "set", "gateway.auth.mode", "{bad", "--json"],
    });
  ...
  it("routes logs to stderr in --json mode so stdout stays clean", async () => {
    await runPreAction({
      ...
      processArgv: ["node", "cimiclaw", "channels", "send", "--json"],
    });
    ...
    await runPreAction({
      ...
      processArgv: ["node", "cimiclaw", "config", "set", "gateway.auth.mode", "local", "--json"],
    });
  ...
  it("does not preload plugins for agents list JSON output", async () => {
    await runPreAction({
      parseArgv: ["agents", "list"],
      processArgv: ["node", "cimiclaw", "agents", "list", "--json"],
    });
  ...
  it("does not preload plugins for remote agent JSON output", async () => {
    await runPreAction({
      parseArgv: ["agent"],
      processArgv: ["node", "cimiclaw", "agent", "--message", "hi", "--json"],
    });
  ...
  it("bypasses config guard for config validate", async () => {
    await runPreAction({
      ...
      processArgv: ["node", "cimiclaw", "config", "validate"],
    });
  ...
  it("bypasses config guard for config validate when root option values are present", async () => {
    await runPreAction({
      parseArgv: ["config", "validate"],
      processArgv: ["node", "cimiclaw", "--profile", "work", "config", "validate"],
    });
  ...
  it("bypasses config guard for config schema", async () => {
    await runPreAction({
      ...
      processArgv: ["node", "cimiclaw", "config", "schema"],
    });
  ...
  it("bypasses config guard for backup create", async () => {
    await runPreAction({
      ...
      processArgv: ["node", "cimiclaw", "backup", "create", "--json"],
    });
