...
vi.mock("./cimiclaw-root.js", async () => {
  const actual = await vi.importActual<typeof import("./cimiclaw-root.js")>("./cimiclaw-root.js");
  return {
    ...actual,
...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    if (!loaded) {
      ({ resolveOpenClawPackageRoot } = await import("./cimiclaw-root.js"));
