...
type RuntimeConfigMutationContext = {
  snapshot: import("../../config/types.cimiclaw.js").ConfigFileSnapshot;
...
type RuntimeMutateConfigFileParams<T = void> = {
  ...
  mutate: (
    draft: import("../../config/types.cimiclaw.js").OpenClawConfig,
    context: RuntimeConfigMutationContext,
  ) => Promise<T | void> | T | void;
};
type RuntimeReplaceConfigFileParams = {
  nextConfig: import("../../config/types.cimiclaw.js").OpenClawConfig;
  baseHash?: string;
  afterWrite: RuntimeConfigAfterWrite;
  writeOptions?: RuntimeWriteConfigOptions;
};
...
export type PluginRuntimeCore = {
  ...
  config: {
    ...
    current: () => DeepReadonly<import("../../config/types.cimiclaw.js").OpenClawConfig>;
    /**
     ...
     */
    loadConfig: () => import("../../config/types.cimiclaw.js").OpenClawConfig;
    /**
     ...
     */
    writeConfigFile: (
      cfg: import("../../config/types.cimiclaw.js").OpenClawConfig,
