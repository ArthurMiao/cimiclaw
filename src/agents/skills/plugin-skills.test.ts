    ...
    plugins: [
      {
        ...
        manifestPath: path.join(params.acpxRoot, "cimiclaw.plugin.json"),
      },
      {
        id: "helper",
        name: "Helper",
        ...
        manifestPath: path.join(params.helperRoot, "cimiclaw.plugin.json"),
      },
    ],
  };
}
    ...
    plugins: [
      {
        ...
        manifestPath: path.join(params.pluginRoot, "cimiclaw.plugin.json"),
      },
    ],
  };
}
