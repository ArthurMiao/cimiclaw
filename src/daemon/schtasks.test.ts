  ...
  it.each([
    {
      ...
      expected: path.join("C:\\Users\\test", ".cimiclaw", "gateway.cmd"),
    },
    {
      ...
      expected: path.join("C:\\Users\\test", ".cimiclaw-jbphoenix", "gateway.cmd"),
    },
    {
    ...
    },
    {
      ...
      expected: path.join("/home/test", ".cimiclaw", "gateway.cmd"),
    },
  ])("$name", ({ env, expected }) => {
