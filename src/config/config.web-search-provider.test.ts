      ...
      plugins: [
        {
          ...
          source: "test",
          manifestPath: "/tmp/plugins/brave/cimiclaw.plugin.json",
        ...
        ...mockWebSearchProviders
          ...
          .map((provider) => ({
            ...
            source: "test",
            manifestPath: `/tmp/plugins/${provider.pluginId}/cimiclaw.plugin.json`,
          ...
          })),
        {
          ...
          source: "test",
          manifestPath: "/tmp/plugins/acme-search/cimiclaw.plugin.json",
