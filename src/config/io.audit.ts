...
export function createConfigWriteAuditRecordBase(params: {
  ...
  return {
    ...
    watchMode: params.env.cimiclaw_WATCH_MODE === "1",
    watchSession: normalizeAuditLabel(params.env.cimiclaw_WATCH_SESSION),
    watchCommand: normalizeAuditLabel(params.env.cimiclaw_WATCH_COMMAND),
