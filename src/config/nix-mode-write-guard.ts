...
export function formatNixModeConfigMutationMessage(params: { configPath?: string } = {}): string {
  return [
    ...
    "Edit the Nix source for this install instead. For nix-openclaw, edit `programs.cimiclaw.config` or `instances.<name>.config`, then rebuild with Home Manager or NixOS.",
