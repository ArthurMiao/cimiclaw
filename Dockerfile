...
LABEL org.opencontainers.image.source="https://github.com/openclaw/openclaw" \
  ...
  org.opencontainers.image.title="CimiClaw" \
  org.opencontainers.image.description="CimiClaw gateway and CLI runtime container image"
...
COPY --from=runtime-assets --chown=node:node /app/cimiclaw.mjs .
...
RUN ln -sf /app/cimiclaw.mjs /usr/local/bin/cimiclaw \
 && chmod 755 /app/cimiclaw.mjs
...
ENTRYPOINT ["tini", "-s", "--"]
CMD ["node", "cimiclaw.mjs", "gateway", "--allow-unconfigured"]
